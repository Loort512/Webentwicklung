...
export default{
  ...
  created(){
    ...
    this.$store.dispatch('addStudent',{id: '7', firstName: 'Laura', lastName: 'Muster', dob: new Date(1998, 1, 1).toLocaleDateString('en-us', { year:"numeric", month:"numeric", day:"numeric"}) , gender: 'w', department: 'HWR', emailID: 'laura.muster@yahoo.de'} );
